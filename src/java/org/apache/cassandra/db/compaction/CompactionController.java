...
public class CompactionController implements AutoCloseable
{
    ...
    public static Set<SSTableReader> getFullyExpiredSSTables(ColumnFamilyStore cfStore, Iterable<SSTableReader> compacting, Iterable<SSTableReader> overlapping, int gcBefore, boolean ignoreOverlaps)
    {
        ...
        if(ignoreOverlaps)
            return getFullyExpiredSSTables(compacting, gcBefore);
    ...
    protected static Set<SSTableReader> getFullyExpiredSSTables(Iterable<SSTableReader> compacting, int gcBefore)
    {
        ...
        return new HashSet<>(fullyExpired);
    }
